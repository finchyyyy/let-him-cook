...
This is lame, and I am working to remove it from its VS shackles. Don't hold your breath, though.
(Update: I broke the VS project LOL)

I am using SFML 2.6 for rendering graphics and keyboard input (yes, I know SFML 3.0 exists. It did not exist when i started this project.)
...
I am almost at the phase where I can start properly creating characters to inhabit my game. I have a couple concepts lined up...  
  ...
  Shawarmageddon - big body that fights with one of those doner kebab skewers (but like, the whole thing). Has a command grab
